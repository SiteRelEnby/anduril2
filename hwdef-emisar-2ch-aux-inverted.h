...
//note swapping of set_level_ch1 and set_level_ch2 - this is how channels are inverted (so still referred to as CM_CH1 in higher level code)
#define SET_LEVEL_MODES      set_level_ch2, \
                             set_level_ch1, \
                             set_level_both, \
                             set_level_blend, \
                             set_level_auto, \
