...
#define RAMP_SMOOTH_CEIL  130 //TODOO: keep 130 for this light, or use 150? since it might be on different FET lights, max regulated seems reasonable at least initially?
