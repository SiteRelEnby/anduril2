...
//#define USE_FANCIER_BLINKING_INDICATOR
...
#ifdef USE_AUX_WHILE_ON_CONFIG //TODO: cleanup
  #ifdef USE_AUX_RGB_LEDS_WHILE_ON_THRESHOLD_LOW
    #ifndef USE_AUX_WHILE_ON_CONFIG_DEFAULT_THRESHOLD_LOW
      #define USE_AUX_WHILE_ON_CONFIG_DEFAULT_THRESHOLD_LOW USE_AUX_RGB_LEDS_WHILE_ON_THRESHOLD_LOW
    #endif
  ...
  #define USE_AUX_RGB_LEDS_WHILE_ON_THRESHOLD_LOW cfg.use_aux_while_on_threshold_low
      ...
      #define USE_AUX_WHILE_ON_CONFIG_DEFAULT_THRESHOLD_HIGH USE_AUX_RGB_LEDS_WHILE_ON_THRESHOLD_HIGH
    #endif
  ...
  #endif
  #if defined(USE_AUX_RGB_LEDS_WHILE_ON_THRESHOLD_LOW) && !defined(USE_AUX_RGB_LEDS_WHILE_ON_THRESHOLD_HIGH)
    #define USE_AUX_RGB_LEDS_WHILE_ON_THRESHOLD_HIGH (RAMP_SIZE+1) //needed for the code to work, so just make it unreachable
  #endif
#endif
