...
//#define USE_AUX_RGB_LEDS_WHILE_ON //this needs to be set to enable configurable RGB voltage // makes no sense on this light (single-colour switch only)
#include "mod-config-siterelenby.h"
#define USER_CONFIG_L0ADED //prevent defaults from loading

// for M44 with XP-E - Hank said 2A/LED may burn the LEDs.
// known to be good at 1.65A
// setting ceiling to 130
...
#define DEFAULT_2C_STYLE 0 //ceil only
