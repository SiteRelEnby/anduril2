...
echo 'These are the default build targets that use attiny1634 or attiny1616. They have not been tested by me (as the saying goes, "Hey, it compiles! Ship it!"), and are provided in the hope they may be useful to someone.' > README.txt
