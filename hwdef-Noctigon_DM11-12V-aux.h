...
#define HWDEF_C_FILE hwdef-Noctigon_DM11-12V-aux.c
...
#define USE_LEGACY_SET_LEVEL
//#define SET_LEVEL_MODES      set_level_main,
#define SET_LEVEL_MODES      set_level_legacy, \
                             set_level_auxred, \
                             set_level_auxyel, \
                             set_level_auxgrn, \
                             set_level_auxcyn, \
...
//#define PWM1_DATATYPE uint32_t
#define PWM_DATATYPE uint16_t
#define PWM1_DATATYPE uint16_t
#define CH1_PWM  OCR1A
